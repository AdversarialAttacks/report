...
\begin{figure}[H]
    ...
    \caption{Übrige Generierte UAPs der mit EfficientNetV2-M trainierten Covidx CXR-4 Datensätze nach jedem Robustifikationslevel durch Adversarial Training von links nach rechts für alle Indizes.}
...
\begin{figure}[H]
    ...
    \caption{Übrige Generierte UAPs der mit EfficientNetV2-M trainierten Hirntumor Datensatz nach jedem Robustifikationslevel durch Adversarial Training von links nach rechts für alle Indizes.}
...
\begin{figure}[H]
    ...
    \caption{Übrige Generierte UAPs der mit EfficientNetV2-S trainierten Covidx CXR-4 Datensätze nach jedem Robustifikationslevel durch Adversarial Training von links nach rechts für alle Indizes.}
...
\begin{figure}[H]
    ...
    \caption{Übrige Generierte UAPs der mit EfficientNetV2-S trainierten Hirntumor Datensatz nach jedem Robustifikationslevel durch Adversarial Training von links nach rechts für alle Indizes.}
