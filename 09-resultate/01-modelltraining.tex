...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Die AUROC-Validierungsmetriken der besten Modelle im Trainingslauf, gemessen an der Validierungs-Verlustmetrik}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.49\linewidth}
        ...
        \caption{AUROC Testmetriken für den MRI Datensatz\\\textcolor{white}{.}}
    \end{subfigure}
    \caption{Die AUROC-Testmetriken der besten Modelle im Trainingslauf, gemessen an der Test-Verlustmetrik}
