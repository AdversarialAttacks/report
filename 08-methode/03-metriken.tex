...
AUROC quantifiziert die Gesamtleistung des Klassifikationsmodells durch die Berechnung der Fläche unter der ROC-Kurve. Ein Wert von 0.5 ist ein schlechtes Modell, das einer zufälligen Klassifikation entspricht, während ein Wert von 1 eine perfekte Klassifikation ohne Fehler bedeutet. AUROC ermöglicht somit eine quantitative Vergleichbarkeit verschiedener Klassifikationsmodelle.
