...
Für $\epsilon$ wird ein kleiner Wert wie $10^{-6}$ gewählt, der eine Division durch 0 verhindert, wenn $L_{\text{BCE,UAP}}$ 0 beträgt. Somit wird das Problem bei der Berechnung der ersten Perturbation gelöst, da zu diesem Zeitpunkt $v_j + \Delta v_j$ einen Nulltensor ergibt. 
...
Ein Flow Chart zum Algorithmus ist bei Abbildung \ref{fig:05-uap_algorithm} im Anhang zu finden. 
